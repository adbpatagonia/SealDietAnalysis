...
preysp$preycat <- ifelse(is.na(preysp$preycat) & between(preysp$preycode, 1100,  9852) , 'invertebrate', preysp$preycat)
...
preysp[grepl("Alepisaurus", preysp$prey.scientific.name), 'preycat'] <- 'lancetfish'
preysp[grepl("Hake,Blue", preysp$prey), 'preycat'] <- 'blue hake'
#preysp[grepl("Threebeard Rockling", preysp$prey), 'preycat'] <- 'threebeard rockling'
#preysp[grepl("Gadoids (Ns)", preysp$prey) | grepl("Cod(Ns)   Gadus Sp", preysp$prey) | grepl("Pollock", preysp$prey) | grepl("Cod,Greenland (Rock)", preysp$prey), 'preycat'] <- 'gadoid'

preysp[grepl("Sebast", preysp$prey.scientific.name), 'preycat'] <- 'redfish'
preysp[grepl("Eelpout", preysp$prey),'preycat'] <- 'eelpout'
preysp$preycat <- ifelse(between(preysp$preycode, 808, 832) , 'fish', preysp$preycat)
#preysp[grepl("Skate", preysp$prey), 'preycat'] <- 'skate'

preysp[grepl("Witch", preysp$prey),'preycat'] <- 'witch flounder'
preysp[grepl("Grenadie", preysp$prey),'preycat'] <- 'grenadier'
...
save(diet, preycat, file = 'interimsteps/diet_categories_hoods_ecopath.rdata')
